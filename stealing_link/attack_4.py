...
def load_data(train_path1, test_path1, train_path2, test_path2):
    ...
    y_test = []
    """
    Dataset in attack_sup_3 contains the train set of target dataset and all from shadow dataset
    """
...
with open("result/attack_4.txt", "a") as wf:
    wf.write(
        "%s,%s,%d,%0.5f,%0.5f,%0.5f,%s\n" %
        (dataset2, "attack_4_transfer_metrics_target:%s_shadow:%s" %
